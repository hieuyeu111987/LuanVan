          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Thêm hình ảnh</h3>
                </div>
            ...
            <div class="card-body">
              <form action="ajax.php?controller=chinhanh&action=doaddhinhanh" method="POST" enctype="multipart/form-data">
                <div class="pl-lg-4">
...
<script>
    function UpImg() {
        $("#hinh").html('<img style="width: 50%; height: 300px;" src="' + URL.createObjectURL(event.target.files[0]) + '" alt="hinhanh">');
